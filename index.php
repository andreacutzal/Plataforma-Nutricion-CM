...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px; margin-left: -65px; font-family: 'IBM Plex Sans', sans-serif;">
            <h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;CLINICA CM</h4>
        </a>
        ...
        <div class="col-md-9 register-right" style="margin-top: 40px; left: 80px;">
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <form method="post" action="func2.php">
                        <div class="row register-form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="contact" class="form-control" placeholder="Número de Teléfono (8 dígitos)" required pattern="^[2-9][0-9]{7}$" title="Debe ser un número de teléfono de Guatemala con 8 dígitos (comenzando con 2 a 9)" onkeydown="return validatePhone(event);">
                                </div>
                                <div class="form-group">
                ...
                <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <h3 class="register-heading">Login Doctor</h3>
                ...
                <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="admin-tab">
                    <h3 class="register-heading">Login Recepcionista</h3>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" integrity="sha384-UO2eT0CpHqdSJQ6Hty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4YfF86dIHNDz0W1" crossorigin="anonymous"></script>

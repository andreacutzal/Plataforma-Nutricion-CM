...
<head>
    ...
    <title>Inicio de Sesión - CLINICA CM</title>
...
<body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px; margin-left: -65px; font-family: 'IBM Plex Sans', sans-serif;">
                <h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp CLINICA CM</h4>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="margin-right: 40px;">
                        <a class="nav-link js-scroll-trigger" href="services.html" style="color: white; font-family: 'IBM Plex Sans', sans-serif;"><h6>NOSOTROS</h6></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-md-7" style="padding-left: 180px;">
                ...
                <div style="color: white;">
                    <h4 style="font-family: 'IBM Plex Sans', sans-serif;">¡Estamos aquí para ti!</h4>
                </div>
            </div>
                ...
                <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
                    <div class="card-body">
                        <center>
                            ...
                            <br>
                            <h3 style="margin-top: 10%">Login Paciente</h3><br>
                            <form class="form-group" method="POST" action="func.php">
                                <div class="row" style="margin-top: 10%">
                                    <div class="col-md-4"><label>Email-ID: </label></div>
                                    <div class="col-md-8"><input type="text" name="email" class="form-control" placeholder="Ingrese su email" required /></div><br><br>
                                    <div class="col-md-4" style="margin-top: 8%"><label>Password: </label></div>
                                    <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password2" placeholder="Ingrese su contraseña" required /></div><br><br><br>
                                </div>
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <a href="recuperar_contrasena.php" style="color: #0062cc; font-size: 0.9em;">¿Olvidaste tu contraseña?</a>
                                </div>
                            </div>
                        </center>
                    </div>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmN7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
